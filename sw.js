...
const SHELL = [
  ...
  './assets/_virtual_lumen-chunk-finance-voice-mZN7w2xz.js',
  './assets/_virtual_lumen-chunk-habits-vault-D2XXyZOA.js',
  './assets/_virtual_lumen-chunk-overview-Bj2a7MNY.js',
  './assets/_virtual_lumen-chunk-settings-schedule-B_dUw5Pa.js',
  './assets/_virtual_lumen-chunk-students-CaZleZud.js',
  './assets/apple-touch-icon-BYj3UHPS.png',
  './assets/controller-DKTw1wv7.js',
  './assets/core-3OYIuWTe.js',
  './assets/icon-512-BQjM7DSE.png',
  './assets/index-BBd1inbw.js',
  './assets/index-C7O9fGwa.css',
  './assets/peerjs.min-DPtSHinz.js',
  './assets/rolldown-runtime-BX80bFGj.js',
  './assets/routes-finance-voice-Bt1BgwQC.js',
  './assets/routes-habits-vault-BZpV1hnP.js',
  './assets/routes-overview-BBgeADmE.js',
  './assets/routes-settings-schedule-DGw0c93Z.js',
  './assets/routes-students-D61sWGed.js',
  './assets/tasks-CWDXIMdG.js',
  './assets/vault-worker-DHYv1t_m.js',
  './assets/view-BfDU64Zh.js',
  './icon-192.png',
  './icon-512.png',
