import { setupTasksController, renderTasks, renderMatrix, openTaskModal, applyTagFilter, matrixShowMore, getSearchTasksHay, getKanbanLists, addKanbanList, renameKanbanList, deleteKanbanList, ensureKanbanLists } from './tasks/controller.js';
import { perfStats as computePerfStats, calculateVelocity } from './perf/view.js';
import * as VaultStore from './vault/view.js';
import { isArchivedTask, linkGraphForTask } from './tasks/view.js';
import { vaultDb, vaultBlobPut, vaultBlobGet, vaultBlobDelete, vaultQuotaUsed as storeVaultQuotaUsed, vaultGuessType, vaultTypeIcon, VAULT_DB, VAULT_STORE, VAULT_MAX_FILE, VAULT_SOFT_CAP, getSearchVaultHay, getVaultHay } from './vault/store.js';
/* ============ Lumen — app logic ============ */
'use strict';
...
async function renderView() {
  ...
  if (view === 'tasks') {
    try {
      const mod = await import('./tasks/controller.js');
